            ...
            {user?.role === 'admin' && (
              <>
                ...
                <button
                  ...
                  className="px-6 py-3 bg-purple-600/20 border border-purple-500/30 rounded-xl font-semibold text-purple-300 hover:bg-purple-600/30 hover:text-white transition-all duration-300"
                >
                  Admin Reports
                </button>
              </>
